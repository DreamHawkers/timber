...
public final class Prompt
{
                                   ...
                                   boolean dirsSelectable, final String extension, final PromptFileListener listener )
    {
        ...
        AlertDialog.Builder builder = prefillBuilder( context, title, message, internalListener );
        if( !dirsSelectable )
                                            ...
                                            final ArrayList<CharSequence> selections, final PromptIntegerListener listener )
    {
        ...
        // Create the dialog builder, removing Ok button and populating list in the process
        AlertDialog.Builder builder = prefillBuilder( context, title, null, internalListener );
        builder.setPositiveButton( null, null );
     ...
     */
    public static AlertDialog.Builder prefillBuilder(Context context, CharSequence title,
