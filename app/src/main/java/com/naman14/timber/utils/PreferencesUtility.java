...
public final class PreferencesUtility {
    ...
    //siron
    private static final String TOGGLE_FOLDER_GRID = "toggle_folder_grid";
    //
    ...
    //siron
    public boolean isFolderInGrid() {
        return mPreferences.getBoolean(TOGGLE_FOLDER_GRID, true);
    }

    public void setFolderInGrid(final boolean b) {
        new AsyncTask<Void, Void, Void>() {
            @Override
            protected Void doInBackground(final Void... unused) {
                final SharedPreferences.Editor editor = mPreferences.edit();
                editor.putBoolean(TOGGLE_FOLDER_GRID, b);
                editor.apply();
                return null;
            }
        }.execute();
